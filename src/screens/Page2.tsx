...
const Page2 = () => {
  const counter = useAppSelector(state => state.ContainerApp_transaction.counter)
  const {userId, token } = useAppSelector(state => state.ContainerApp_login)
      ...
      <SafeAreaView>
        <ScrollView contentInsetAdjustmentBehavior="automatic">
          <View style={commonStyles.container}>
            <View>
              <Text style={commonStyles.titles}>ContainerApp Page 2</Text>
            </View>
